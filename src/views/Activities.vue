<template>
  <div id="activities" class="under-header padding-bottom">
    <div class="container">
      ...
      <div class="panel">
        <h1 style="text-transform: uppercase;">TBD - Talk motivadora</h1>
        <div>
          <h3>Speaker: Clara Prats</h3>
      ...
      <div class="panel">
        <h1 style="text-transform: uppercase;">TBD - Interficies y privacitat</h1>
        <div>
      ...
      <div class="panel">
        ...
        <div>
          <div class="margin-bottom text-centered">
            <p class="icon"><i data-src="/assets/img/icons/discord.png" aria-hidden="true"></i></p>
